# -*- coding: utf-8 -*-
# @Time    : 2019/4/19 下午10:52
# @Author  : hai
# @FileName: Matrix_Factorization.py
# @Software: 
...
class Matrix_Factorization(object):
    ...
    def start(self):
        ...
        while epoch_num <= self.epoch:
            ...
            error = e.dot(e)
            print
            'The error is %s=================Epoch:%s' % (error, epoch_num)
            epoch_num += 1
...
if __name__ == '__main__':
    user_rating = pd.read_csv(
        '/home/mo/workspace/Graduation_Project/Recommondation-System/data/ml-latest-small/user_rating.csv', index_col=0)
